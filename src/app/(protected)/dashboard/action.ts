...
export async function askQuestion(question: string, projectId: string){
    ...
    (async ()=> {
        const { textStream } = await streamText({
            ...
            AI has the sum of all knowledge in their brain, and is able to accurately answer nearly any question about any topic in conversation.If the question is asking about code or a specific file, AI will provide the detailed answer, giving step by step instructions, including code snippets.
            ...
            Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering, and make sure there is no extra generated code snippets, only take code snippets from context.
            `
        });
